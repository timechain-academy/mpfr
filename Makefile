...
ACLOCAL = ${SHELL} '/Volumes/git/pi_c/mpfr/missing' aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} '/Volumes/git/pi_c/mpfr/missing' autoconf
AUTOHEADER = ${SHELL} '/Volumes/git/pi_c/mpfr/missing' autoheader
AUTOMAKE = ${SHELL} '/Volumes/git/pi_c/mpfr/missing' automake-1.16
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -Wall -Wmissing-prototypes -Wpointer-arith -O2 -fomit-frame-pointer -m64 -mtune=sandybridge -march=sandybridge
CPP = gcc -E
CPPFLAGS = 
CSCOPE = cscope
CTAGS = ctags
...
LD = /Volumes/git/XcodeVersions/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ld
...
LT_SYS_LIBRARY_PATH = 
MAINT = 
MAKEINFO = ${SHELL} '/Volumes/git/pi_c/mpfr/missing' makeinfo
MANIFEST_TOOL = :
...
TUNE_LIBS = 
VERSION = 4.1.1
abs_builddir = /Volumes/git/pi_c/mpfr
abs_srcdir = /Volumes/git/pi_c/mpfr
abs_top_builddir = /Volumes/git/pi_c/mpfr
abs_top_srcdir = /Volumes/git/pi_c/mpfr
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Volumes/git/pi_c/mpfr/install-sh
